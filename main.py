...
string_hello = '''Зравствуйте, вас приветствует служба поддержки Ростелекома.
Пожалуйста введите ваш запрос...'''


string_input = '''Пожалуйста введите ваш запрос...'''


@dp.message_handler(commands=['start'])
async def start_command(msg: types.Message):
	await bot.send_message(msg.from_user.id, string_hello)


@dp.message_handler(commands=['help'])
async def input_please(msg: types.Message):
	await bot.send_message(msg.from_user.id, string_input)
